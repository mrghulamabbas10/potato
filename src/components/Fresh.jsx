        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-7xl mx-auto">
          ...
          <div className="text-center space-y-6 max-w-xl mx-auto">
            ...
            <div className="space-y-4">
              <h1
                className="text-4xl md:text-5xl lg:text-[57px] font-semibold leading-[1.1] text-black"
                style={{ fontFamily: "Urbanist, sans-serif" }}
              >
              ...
              <div className="flex justify-center">
                <div className="bg-pot-brown text-white px-6 md:px-10 py-3 md:py-4 rounded-lg transform -rotate-1 shadow-lg inline-block">
                  <span
                    className="text-4xl md:text-5xl lg:text-[57px] font-semibold whitespace-nowrap"
                    style={{ fontFamily: "Urbanist, sans-serif" }}
                  >
                    long days
                  </span>
            ...
            <button
              className="bg-pot-brown hover:bg-pot-dark-brown text-white px-10 md:px-12 py-3 md:py-4 rounded-full text-lg md:text-xl font-semibold shadow-lg transition-colors flex items-center gap-3 mx-auto"
              style={{ fontFamily: "Urbanist, sans-serif" }}
            >
              <svg
                className="w-5 h-5 md:w-6 md:h-6 opacity-20"
                fill="white"
                viewBox="0 0 23 23"
              >
                <path
          ...
          <div className="relative min-h-[500px] md:min-h-[600px] flex items-center justify-center">
            ...
            <div className="absolute top-0 left-0 md:left-8 z-20">
              <img
                src="https://api.builder.io/api/v1/image/assets/TEMP/5cfd18a5d60c07971ec32e37c8699751fc9f2f24?width=440"
                alt="Fresh"
            ...
            <div className="relative z-10">
              ...
              <div className="absolute top-12 md:top-16 left-1/2 transform -translate-x-1/2 text-center whitespace-nowrap">
                <h3
              ...
              <div className="absolute bottom-12 md:bottom-16 right-0 text-center whitespace-nowrap">
                <h3
                  className="text-3xl md:text-4xl lg:text-[57px] font-bold text-white leading-none"
                  style={{
                    fontFamily: "Urbanist, sans-serif",
            ...
            <div className="absolute -top-8 -right-12 hidden xl:block opacity-90 z-0">
              <img
                src="https://api.builder.io/api/v1/image/assets/TEMP/e5daa9c3697e7b9347e52126ffa9815038ba79c1?width=820"
                alt="Decoration"
