...
export default function RightSection() {
    return (
        <motion.div
            className="md:col-span-2 lg:col-span-1 rightSide relative bg-pot-brown flex-1 flex flex-col items-center justify-center px-6 xl:px-12 py-8 lg:py-16 2xl:py-32 overflow-hidden md:rounded-none rounded-br-2xl"
        ...
        >
            ...
            >
                <motion.img
                    ...
                    alt="Loaded potatoes"
                    className="w-36 md:w-56 lg:w-64 h-auto mx-auto mb-2 md:mb-8"
            ...
            <motion.img
                ...
                className="absolute top-10 right-10 md:right-5 w-20 md:w-28 lg:w-32 h-auto opacity-90"
